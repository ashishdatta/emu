/// 8080 Disassembler written in C 
/// Ashish Datta
/// 4/18/2015
/// sudo cc -g -O0 main.c
...
/// buff is pointer to 8080 assembly code and pc is the current offset in code
/// Return: # of bytes of the operation
...
int Disassemble8080p(unsigned char *buff, int pc)
{
    unsigned char *code = buff + pc;
    int op_bytes = 1; // Default value is 1 byte, if op takes more changes appear in switch statement
    printf("%04x ", pc);

    /// 8080 reference found here: http://www.emulator101.com.s3-website-us-east-1.amazonaws.com/8080-by-opcode/
    switch(*code)
    {
        ...
        case 0x21: printf("LXI      D,#$%02x%02x", code[2], code[1]); op_bytes=3; break;
        case 0x22: printf("SHLD     addr,$%02x%02x", code[2], code[1]); op_bytes=3; break;
        ...
        case 0x2a: printf("LHLD     addr,$%02x%02x", code[2], code[1]); op_bytes=3; break;
        ...
        case 0x3a: printf("LDA      addr,$%02x%02x", code[2], code[1]); op_bytes=3; break;
        ...
        case 0x77: printf("MOV      A,A"); break;
        ...
        case 0xcb: printf("JMP    $%02x%02x",code[2],code[1]); op_bytes = 3; break;
        ...
        case 0xdd: printf("CALL   $%02x%02x",code[2],code[1]); op_bytes = 3; break;
        ...
        case 0xed: printf("CALL   $%02x%02x",code[2],code[1]); op_bytes = 3; break;
        ...
        case 0xfd: printf("CALL   $%02x%02x",code[2],code[1]); op_bytes = 3; break;
